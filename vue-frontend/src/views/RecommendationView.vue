...
<style scoped>
.recommend-layout{display:grid;grid-template-columns:1fr 280px;gap:16px}.recommend-form{min-height:570px;padding:32px}.step-head{display:flex;align-items:center;gap:15px;margin-bottom:34px;color:var(--muted);font-family:var(--font-display);font-size:9px;font-weight:800;letter-spacing:.08em}.step-head .progress{flex:1}.recommend-form h2{font-size:24px}.recommend-form>p{margin:7px 0 27px;color:var(--muted);font-size:11px}.choice-grid{display:grid;gap:10px;margin:20px 0 30px}.choice-grid button{position:relative;display:flex;align-items:center;gap:12px;padding:15px;color:var(--ink);background:var(--surface);border:1px solid var(--line);border-radius:12px;text-align:left}.choice-grid button.selected{background:var(--lime-soft);border-color:#a7cb58}.choice-grid button>span{width:35px;height:35px;display:grid;place-items:center;background:var(--surface-2);border-radius:8px;font-family:var(--font-display);font-size:10px;font-weight:800}.choice-grid strong,.choice-grid small{display:block}.choice-grid strong{font-size:12px}.choice-grid small{margin-left:auto;color:var(--muted);font-size:9px}.choice-grid button>svg:last-child{margin-left:auto;color:var(--forest-2)}.languages{grid-template-columns:repeat(3,1fr)}.situations{grid-template-columns:repeat(2,1fr)}.situations button{display:grid;grid-template-columns:auto 1fr}.situations small{grid-column:2;margin-left:0}.recommend-form h3{margin-bottom:10px;font-size:12px}.segment{display:grid;grid-template-columns:repeat(3,1fr);padding:4px;background:var(--surface-2);border-radius:11px}.segment button{padding:9px;color:var(--muted);background:transparent;border-radius:8px;font-size:11px;font-weight:700}.segment button.active{color:var(--forest);background:var(--surface);box-shadow:var(--shadow-sm)}.step-actions{display:flex;justify-content:flex-end;gap:8px;margin-top:32px}.summary-card{display:flex;gap:11px;margin-top:18px;padding:14px;color:var(--purple);background:var(--purple-soft);border-radius:11px;font-size:10px}.summary-card strong,.summary-card span{display:block}.summary-card strong{margin-bottom:2px}.guide-card{height:max-content;padding:24px;color:#bed0c5;background:var(--forest);border-radius:18px}.guide-card>svg{color:var(--lime)}.guide-card h3{margin:18px 0 9px;color:white;font-size:16px}.guide-card p{font-size:10px;line-height:1.7}.guide-card ul{display:grid;gap:10px;margin:23px 0 0;padding:18px 0 0 17px;border-top:1px solid rgba(255,255,255,.1);font-size:9px}.results{margin-top:44px}.result-title{display:flex;align-items:flex-end;justify-content:space-between;margin-bottom:16px}.result-title h2{margin-top:8px;font-size:22px}.result-controls{display:flex;align-items:center;gap:8px;color:var(--muted);font-size:9px}.result-controls select{padding:8px 28px 8px 10px;background:var(--surface);border:1px solid var(--line);border-radius:8px;font-size:9px}.result-notice{display:flex;align-items:flex-start;gap:11px;margin-bottom:14px;padding:14px;color:var(--purple);background:var(--purple-soft);border-radius:12px;font-size:9px}.result-notice.fallback{color:#735315;background:#fff2d1}.result-notice span,.result-notice strong{display:block}.result-notice strong{margin-bottom:3px;font-size:10px}.result-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:14px}@media(max-width:900px){.recommend-layout{grid-template-columns:1fr}.guide-card{display:none}.result-grid{grid-template-columns:repeat(2,1fr)}}@media(max-width:620px){.recommend-form{padding:22px}.languages,.situations,.result-grid{grid-template-columns:1fr}.result-title{align-items:flex-start;flex-direction:column;gap:12px}}
</style>
